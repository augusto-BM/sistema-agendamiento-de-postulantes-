            ...
            <div class="card-body">
                ...
                <div class="row mb-2">
                    <div class="col-md-4">
                        ...
                        <input type="text" id="tipo_documento" name="tipo_documento" class="form-control ver" value="<?= $date->tipodocumento; ?>" placeholder="Sin dato">

                    </div>

                    <div class="col-md-4">
                        <label for="numero_documento" class="form-label">NUMERO DE DOC. </label>
                        <input type="text" id="numero_documento" name="numero_documento" class="form-control ver" value="<?= $date->dni; ?>" placeholder="Sin dato">
                    </div>

                    <div class="col-md-4">
                        <label for="fecha_ingreso" class="form-label">FECHA DE INGRESO </label>
                        <input type="text" id="fecha_ingreso" name="fecha_ingreso" class="form-control ver" value="<?= $date->fechaingreso; ?>" placeholder="Sin dato">
                    </div>
                </div>
                ...
                <div class="row mb-2">
                    <div class="col-md-4">
                        ...
                        <input type="text" id="id_empresa" name="id_empresa" class="form-control ver" value="<?= $date->nombreempresa; ?>" placeholder="Sin dato">
                    </div>

                    <div class="col-md-4">
                        <label for="turno" class="form-label">TURNO </label>
                        <input type="text" id="turno" name="turno" class="form-control ver" value="<?= $date->turno; ?>" placeholder="Sin dato">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" id="id_rol" name="id_rol" class="form-control ver" value="<?= $date->nombrerol; ?>" placeholder="Sin dato">
                    </div>
                </div>
                ...
                <div class="row mb-2">
                    <div class="col-md-4">
                        ...
                        <input type="text" id="correo_electronico" name="correo_electronico" class="form-control ver" value="<?= $date->correo; ?>" placeholder="Sin dato">
                    </div>
                    <div class="col-md-4">
                        <label for="celular" class="form-label">CELULAR </label>
                        <div class="input-group input-group-merge">
                            <span class="input-group-text" style="color: #697a8d;">PE (+51)</span>
                            <input type="text" id="celular" name="celular" class="form-control ver" value="<?= $date->celular; ?>" placeholder="Sin dato" maxlength="9">
                        </div>
                    </div>
