...
<style>
    .contenedor_usuariosInactivos i {
        font-size: 18px !important;
    }
</style>

<div class="container contenedor_usuariosInactivos modal-page-usuariosInactivos page-1">
    <div class="formulario_usuariosInactivos">
        <!--         <div class="card mb-4">
            <div class="card-body"> -->
        ...
        <div class="row mt-2 filtradoFecha">
            ...
            <div class="col-md-3">
                ...
                <select class="form-control" id="filtroSedesDesactivos">
                    <?php if ($sedes): ?>
            ...
            <div class="col-md-5 d-flex flex-column justify-content-center">
                <div class="row m-2">
                    <div class="col-md-12 d-flex">
                        <button id="btnBuscarSearchDataDesactivos" class="btn btn-primary"
                            style="margin-right: 3px; display: none;">Buscar</button>
                        <input class="form-control" type="search" id="buscarSearchDataDesactivos"
        ...
        <div class="table-responsive col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <table class="table table-borderless table-hover w-100 tabla-general" id="myTablaUsuariosDesactivos">
...
<script src="../../../public/js/usuarios/ajaxListarUsuariosDesactivos.js"></script>